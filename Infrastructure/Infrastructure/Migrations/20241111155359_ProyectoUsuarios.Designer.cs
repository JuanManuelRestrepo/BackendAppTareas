...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20241111155359_ProyectoUsuarios")]
    partial class ProyectoUsuarios
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoUsuario", b =>
                {
                    b.Property<Guid>("ProyectoUsuariosId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ProyectoUsuariosId1")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("ProyectoUsuariosId", "ProyectoUsuariosId1");

                    b.HasIndex("ProyectoUsuariosId1");
            ...
            modelBuilder.Entity("ProyectoUsuario", b =>
                {
                    b.HasOne("Domain.Proyecto", null)
                        .WithMany()
                        .HasForeignKey("ProyectoUsuariosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Usuario", null)
                        .WithMany()
                        .HasForeignKey("ProyectoUsuariosId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
